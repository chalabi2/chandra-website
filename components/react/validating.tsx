  ...
  return (
    <VStack className="background-image-container2">
      <Box
        ...
        p={4}
        mt={useBreakpointValue({ base: "400", md: "800px" })}
        zIndex={1}
        ml={0}
        textAlign="center"
      >
      ...
      <Box zIndex={1} ml={0} textAlign="center">
          ...
          <GridItem>
            <Flex p="2" height={20} textAlign={"left"} flexDirection="column">
              ...
              <Box width="20em" height="0em">
                <SkeletonText noOfLines={1} isLoaded={Number(tvl) !== 0}>
        ...
        >
          <GridItem rowSpan={1} colSpan={1}>
            <Flex
              mt={useBreakpointValue({ base: 20, md: 0 })}
              p="2"
              width={400}
              textAlign={"left"}
              flexDirection="column"
              marginLeft={marginLeftFlex}
            >
              <Heading fontSize={{ base: "1xl", sm: "2xl", md: "3xl" }}>
                Hardware
              </Heading>
              ...
              <Icon
                mt={8}
                boxSize={useBreakpointValue({ base: "100px", md: "150px" })}
                alignSelf="flex-end"
              >
                <IoServerSharp />
              </Icon>
